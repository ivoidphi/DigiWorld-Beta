...
public class GamePanel extends JPanel implements Runnable {
    ...
    private final WorldSoundManager soundManager;
    ...
    public GamePanel() {
        ...
        random = new Random();
        soundManager = new WorldSoundManager();
        worldIndex = 0;
    ...
    public void startGame() {
        ...
        soundManager.playMusicForWorld(worlds[worldIndex].getName());
    ...
    private void teleportWithFade(int targetWorldIndex) {
        ...
        new Thread(() -> {
            ...
            synchronized (this) {
                ...
                encounterCooldownTimer = 1.5;
                fadeTarget = 0.0;
                soundManager.playMusicForWorld(world.getName());
            }
        }).start();
    }
